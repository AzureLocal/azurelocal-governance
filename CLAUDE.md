# azurelocal-governance — Claude Code Context
...
- `azurelocal-governance-engineer` (model: sonnet) — Expert in `azurelocal-governance`: deep knowledge of this repo's structure, conventions, and development workflow.
