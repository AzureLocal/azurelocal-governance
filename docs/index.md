...
Azure Policy, security baselines, and CIS benchmark automation for Azure Local.
...
- [GitHub Repository](https://github.com/AzureLocal/azurelocal-governance)
